...
export function rectangle(sP, eP) {
    let allP = [];
    ...
    let l;
    allP.push(...lH, ...lV, ...tH, ...tV);
    return allP
}

export function filledRectangle(sP, eP) {
    let allP = [];
    let lH = line(new Point(sP.x, eP.y), new Point(eP.x, eP.y))
    let lV = line(new Point(sP.x, sP.y), new Point(sP.x, eP.y))
    let tH = line(new Point(sP.x, sP.y), new Point(eP.x, sP.y))
    ...
    let l;
    allP.push(...lH, ...lV, ...tH, ...tV);
    allP.push(new Rect(sP.x, sP.y, eP.x, eP.y))
    return allP
}
...
export function ellipse(x0, y0, x1, y1) {
    var ox0 = x0
    var oy0 = y0
    var ox1 = x1
...
export function filledEllipse(x0, y0, x1, y1) {
    var ox0 = x0
    var oy0 = y0
    var ox1 = x1
    var oy1 = y1 /* rectangular parameter enclosing the ellipse */
